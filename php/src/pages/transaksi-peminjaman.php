...
<div id="content">
    <p id="tombol-tambah-container">
        <a href="index.php?p=transaksi-pinjam-input" class="tombol"><img src="images/add.png" height="50px" height="50px"></a> 
    ...
    <table id="tabel-tampil"> 
		...
		<tr>
            ...
            <td>
                    <div class="tombol-opsi-container"><a href="index.php?p=transaksi-peminjaman-edit&id=<?php echo $r_tampil_pinjam['idpeminjaman'];?>" class="tombol">Edit</a></div> 
                    <div class="tombol-opsi-container"><a href="proses/transaksi-peminjaman-hapus.php?id=<?php echo $r_tampil_pinjam['idpeminjaman'];?>" onclick = "return confirm ('Apakah Anda Yakin Akan Menghapus Data Ini?')" class="tombol">Hapus</a></div> 
            </td>
