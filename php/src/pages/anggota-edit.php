...
<div id="content">
	...
	<table id="tabel-input">
		...
		<tr> 
                ...
                <?php 
                    if($r_tampil_anggota['status']=="Sedang Meminjam") {
                        echo "<td class='isian-formulir'><input type='radio' name='status' value='Sedang Meminjam' checked>Sedang Meminjam</label></td> 
            </tr> 
            <tr>    
                <td class='label-formulir'></td> 
                <td class='isian-formulir'><input type='radio' name='status' value='Tidak Meminjam'>Tidak Meminjam</td>"; 
                    } elseif($r_tampil_anggota['status']=="Tidak Meminjam") {
                        echo "<td class='isian-formulir'><input type='radio' name='status' value='Sedang Meminjam'>Sedang Meminjam</label></td> 
            </tr> 
            <tr>
                <td class='label-formulir'></td> 
                <td class='isian-formulir'><input type='radio' name='status' value='Tidak Meminjam' checked>Tidak Meminjam</td>"; 
                    } 
                ?> 
