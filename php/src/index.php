...
// cek apakah variabel global ada dan tidak kosong (yang berarti aktif login)
...
<body >
	<div id="container">
		...
		<div id="sidebar">
			...
			<ul>
				<li><a href="index.php?p=Laporan-peminjaman">Laporan Peminjaman</a></li>
				<li><a href="index.php?p=Laporan-pengembalian">Laporan Pengembalian</a></li>
			</ul>
