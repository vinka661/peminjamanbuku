...
<div id="content">
	...
	<a target="_blank" href="proses/anggota-ekspor-pdf.php"><img src="images/pd.png" height="50px" height="50px"></a>&nbsp;&nbsp;
	<a target="_blank" href="proses/anggota-expor-excel.php"><img src="images/ex.png" height="50px" height="50px"></a>&nbsp;
	...
	<table id="tabel-tampil">
		...
		//pengecekan apakah terdapat data di data base, jika ada di tampilkan
		if(mysqli_num_rows($q_tampil_anggota)>0)
		{
			//melakukan looping data anggota sesuai data base
